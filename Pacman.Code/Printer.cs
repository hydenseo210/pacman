...
public class Printer
{
    ...
    public Printer(IMap map, IConsoleWrapper console, IThreadSleeper _thread)
    {
        _map = map;
        _console = console;
    ...
    public void DashBoard() => _console.Write(Messages.DashBoardMessage(_map.CurrentScore, _map.TotalScore, _map.LivesList));
