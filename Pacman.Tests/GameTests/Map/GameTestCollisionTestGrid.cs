...
public static class GameTestCollisionTestGrid
{
    public static readonly Dictionary<Coordinate, Cell> actualGrid = new ()
    {
        ...
        [new Coordinate(2,4)] = new ThePacman(),
    ...
    public static readonly Coordinate ActualPacmanCoordinate = new (2, 4);
    public static readonly Coordinate ActualBlinkyCoordinate = new (2, 5);
    public static readonly Coordinate ExpectedPacmanCoordinate = new (2, 4);
